...
const Drawer = () => {
  ...
  return (
    ...
    <div className='container h-full relative flex justify-center items-end gap-2 sm:gap-4  md:gap-6 lg:gap-6'>
      <div className="absolute w-[65%] top-0 left-0 p-1 text-md sm:text-3xl leading-relaxed tracking-wider z-10 ">
        <motion.p 
      ...
      <motion.div className="basis-1/2 h-[47%] bg-slate-800 rounded-lg mb-[3%] overflow-hidden" style={{x:x}}  >
      ...
      <div className="basis-1/2 h-[140%] flex flex-col justify-end items-start gap-2 sm:gap-4  md:gap-6 lg:gap-6">
        <div className='w-[100%] h-[100%] flex justify-start items-end gap-2 sm:gap-4  md:gap-6 lg:gap-6'>
          ...
          <motion.div className='w-[60%] h-[65%] bg-emerald-600 rounded-lg overflow-hidden' style={{x:x3}}>
