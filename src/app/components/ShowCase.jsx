...
const ShowCase = () => {
  return (
    <div className="sm:container mx-auto w-full max-h-screen h-[40vh] sm:h-[50vh] lg:h-[60vh] xl:h-[70vh] relative flex justify-end items-center p-0 sm:p-5 mb-10 sm:mb-4">
      <div className="w-2/3 sm:w-1/3 absolute top-auto bottom-[0%] left-[50%] sm:bottom-auto sm:top-[50%] sm:left-[5%] translate-x-[-50%] sm:translate-x-[0px] sm:translate-y-[-50%] translate-y-[33%] p-3 sm:p-5 text-center bg-slate-200/80 sm:rounded-md z-10">
        <p className="text-lg tracking-wider text-base">
      ...
      <div className="w-full sm:w-[80%] h-full relative bg-slate-200 sm:rounded-md overflow-hidden">
        ...
        >
          ...
          <Image src={nextIcon} alt="previous_icon" className="rotate-180" />
          </div>
          <div className="slider-next absolute flex justify-center items-center w-8 h-8 sm:w-10 sm:h-10 sm:bottom-[10px] sm:top-auto top-[50%] translate-y-[-50%]  sm:translate-y-[0px] right-[-40px] group-hover:right-0 mr-0 sm:mr-2 transition-all cursor-pointer z-10">
            <Image src={nextIcon} alt="next_icon" className="text-slate-400" />
          </div>
        </Swiper>
      </div>
    </div>
